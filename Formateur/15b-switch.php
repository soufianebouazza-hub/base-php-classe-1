...
<head>
    ...
    <title>15b - Switch</title>
</head>
<body>
    <h1>15b - Switch</h1>
    <p>Copie de 15-conditions.php, avec un switch : générez un chiffre entre 0 et 10, puis affichez : 0-3 → "X : Nul, étudie la prochaine fois", 4-5 → "X : Peut mieux faire", 6-7 → "X : Bien", 8-10 → "X : Très bien".</p>
    <h3><?= $resultat ?></h3>
